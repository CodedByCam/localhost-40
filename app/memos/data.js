const bolognaSections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Architecturally, the system had three layers: a student-facing iOS client, a workflow engine that translated college administration into discrete tasks, and an integration layer that connected admissions, financial aid, course, and payment systems. The student experience stayed intentionally simple: tap, type, read, and complete the next best action. The complexity lived behind the interface, where background jobs monitored state changes, routed data between systems, and surfaced moments that required student, staff, legal, or college review.`,
    ],
  },
  {
    id: "admissions",
